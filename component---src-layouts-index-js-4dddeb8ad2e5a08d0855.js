...
/***/ (function(module, exports, __webpack_require__) {
	...
	var DiscordWidget = function () {
	    ...
	    return function DiscordWidget() {
	        return _ref.apply(this, arguments);
	    };
	}();
	
	exports.default = DiscordWidget;
	module.exports = exports["default"];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Template = function (_React$Component) {
	    ...
	    Template.prototype.render = function render() {
	        ...
	        (0, _DiscordWidget2.default)().then(function (_) {
	            return console.log('Discord widget successfully loaded');
	        }).catch(function (err) {
	            return console.error('Error loading discord widget', err);
	        });
...
//# sourceMappingURL=component---src-layouts-index-js-4dddeb8ad2e5a08d0855.js.map